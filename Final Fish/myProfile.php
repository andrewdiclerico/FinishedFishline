...
<body>
    ...
    <div class="container">
        ...
        <div>
            <?php
                echo "<img src='/SE266/Final Fish/Images/" .  $row['userphoto'] . "' style='width: 150px; padding-bottom:10%;'></img>";
            ?>
        </div>
        ...
        <div style="height:35px; width:65; float:left;">
            ...
            <br>
            <a href="addfish.php?username=<?php echo $row['username'] ?>"><button><img src="Images/icon.png" style="padding:5%; height:35px; width:35px;"></img></button></a>
        </div>
